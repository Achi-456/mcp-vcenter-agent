...
export function MetricCard({ title, value, subtitle, status }: MetricCardProps) {
  return (
    <article className="min-w-0 rounded-2xl border border-ops-steel/10 bg-white p-5 shadow-card">
      ...
      <div className="mt-4 break-words text-3xl font-bold tracking-tight text-ops-ink">{value}</div>
